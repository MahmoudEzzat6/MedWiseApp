...
class EyesDetailScreen extends StatelessWidget {
  final EyesModel model;
  const EyesDetailScreen({Key? key, required this.model}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('${model.symptomsDiseaseEyes}',
                  style: TextStyle(
