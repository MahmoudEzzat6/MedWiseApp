...
class KidneysDetailScreen extends StatelessWidget {
  final KidneysModel model;
  const KidneysDetailScreen({Key? key, required this.model}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('${model.symptomsDiseaseKidneys}',
                  style: TextStyle(
                      fontWeight: FontWeight.w500, fontSize: hight / 40)),
            ],
          ),
